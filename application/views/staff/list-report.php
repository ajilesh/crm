                ...
                <table id="tasktable" class="table table-bordered table-striped">
                    ...
                    //     ->get();
                        ...
                        switch($cnt->status){
                            ...
                            case "complete" :
                                ...
                                break;  
                                default:
                                $stat = '<a class="badge badge-success" style="background-color: orange;">Inproceess</a>';
                                break;
                  ...
                  ?>
                      <tr>
                        ...
                        <td><?php echo $cnt->start_time; ?></td>
                        <td><?php echo $cnt->end_time; ?></td>
                        <td><?php echo substr_replace($cnt->report_content, "", 50);
                         ?></td>
                        <td><?php echo $stat; ?></td>
                        <td>
                          <!-- <a href="" class="btn btn-success">Edit</a> -->
                          <a href="<?= base_url();?>view-list-report/<?= $cnt->id;?>" class="btn btn-primary">View</a>
                          <a href="" class="btn btn-info">Edit</a>
                          <a href="<?= base_url();?>delete-list-report/<?= $cnt->id;?>" class="btn btn-danger">Delete</a>
