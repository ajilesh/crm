...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>" class="logo">
      ...
      <span class="logo-mini"><b>MEEM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>MEEM</b> EMS</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-file-word-o"></i> <span>Work Report</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>work-report"><i class="fa fa-file-word-o"></i> Report</a></li>
            <li><a href="<?php echo base_url(); ?>staff-list-report"><i class="fa fa-file-word-o"></i> List Report</a></li>
          </ul>
        </li>
        <!-- end Work Report -->
        <!-- Customer -->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>add-customer">Add Customer</a></li>
          </ul>
        </li>
        <!-- end Work Report -->
        <!-- task  -->
        <li class="treeview">
          <a href="#">
            <i class="fa fa-user"></i> <span>Task</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>staff-list-task">Task list</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
