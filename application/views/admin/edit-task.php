            ...
            <?php echo form_open_multipart('task/taskInsert');?>
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    <label>Title</label>
                    <input type="text" name="task" value="<?= $data->title; ?>" id="task" class="form-control">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    {?>
                      ...
                      <?= ($staff['staff_name'] == $data->staff_name) ? 'selected' : '';?>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input id="stime" value="<?= $data->stime;?>" type="datetime-local" name="stime" class="form-control">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label>End Time</label>
                    <input type="datetime-local" value="<?= $data->etime;?>" name="etime" id="etime" class="form-control">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" name="approve" id="approve">
                     <option value="0" 
                     <?= ($data->approved == 0) ? 'selected' : '' ?>
                     >Disapprove</option>
                     <option value="1" <?= ($data->approved == 1) ? 'selected' : '' ?>>Approve</option>
