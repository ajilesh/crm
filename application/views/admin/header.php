...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini">MEEM</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">MEEM</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-usd"></i> <span>Task</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>assign-task"><i class="fa fa-circle-o"></i> Assign Task</a></li>
            <li><a href="<?php echo base_url(); ?>task-list"><i class="fa fa-circle-o"></i> Task List</a></li>
          </ul>
        </li>
        <!-- report -->
        <li class="treeview">
          <a href="#">
            <i class="fa fa-usd"></i> <span>Report</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>list-report"><i class="fa fa-circle-o"></i> List Report</a></li>
            <li><a href="<?php echo base_url(); ?>all-report"><i class="fa fa-circle-o"></i> All Report</a></li>
          </ul>
        </li>
        <!-- settings -->
        <li class="treeview">
          <a href="#">
            <i class="fa fa-usd"></i> <span>Settings</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>role-setting"><i class="fa fa-circle-o"></i>Role</a></li>
