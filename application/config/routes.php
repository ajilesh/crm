...
//work report
$route['work-report'] = 'workreport/workReport';
$route['list-report'] = 'workreport/listReport';
$route['delete-list-report/(:num)'] = 'workreport/deleteListReport/$1';
$route['view-list-report/(:num)'] = 'workreport/viewListReport/$1';
$route['admin-view-list-report/(:num)'] = 'workreport/adminViewListreport/$1';
$route['staff-list-report'] = 'workreport/staffListReport';
$route['all-report'] = 'workreport/allReport';
$route['search-report'] = 'workreport/searchReport';
$route['report-pdf/(:num)'] = 'workreport/pdfReport/$1';
//setting
$route['role-setting'] = 'setting';
//customer
$route['add-customer'] = 'customer';

//task
$route['task-view/(:num)'] = 'task/taskView/$1';
$route['task-edit/(:num)'] = 'task/taskEdit/$1';
$route['assign-task'] = 'task/index';
$route['task-list'] = 'task/listTask';
$route['staff-list-task'] = 'task/staffListTask';
$route['edit-task-list/(:num)'] = 'task/editTask/$1';
$route['delete-task-list/(:num)'] = 'task/deleteTask/$1';
